...
from database2 import simpan_saldo, ambil_saldo  # Import fungsi dari database.py
from database2 import simpan_jurnal, ambil_jurnal  # pastikan ini sudah di-import
from database2 import ambil_saldo, ambil_jurnal
...
if menu == "Laporan Posisi Keuangan":
    ...
    if not neraca_saldo:
        ...
        if total_aset != total_passiva:
            st.warning("⚠ Total Aset tidak sama dengan Total Liabilitas + Ekuitas!")
